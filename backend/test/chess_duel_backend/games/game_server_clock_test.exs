defmodule ChessDuelBackend.Games.GameServerClockTest do
  ...
  test "Blitz 5+0 desconta o tempo sem aplicar incremento" do
    ...
    assert after_white_first.white_time_remaining_ms <= 300_000
    assert after_white_first.white_time_remaining_ms > 299_500
    ...
    assert after_white_second.white_time_remaining_ms < 300_000
    assert after_white_second.white_time_remaining_ms > 299_000
  end
