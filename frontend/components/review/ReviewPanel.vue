...
.engine-score { display: flex; align-items: center; gap: .65rem; }.engine-score strong { min-width: 66px; color: var(--text); font: 700 1.8rem/1 ui-monospace, SFMono-Regular, monospace; }.engine-status { display: grid; width: 32px; height: 32px; place-items: center; color: var(--accent-ink); background: var(--success); border-radius: 7px; }.engine-meta { display: grid; gap: .15rem; }.engine-meta b { font-size: .9rem; }.engine-meta span { color: var(--text-muted); font-size: .75rem; }
.players { display: flex; padding: .75rem 1rem; align-items: center; justify-content: space-between; gap: .6rem; border-bottom: 1px solid var(--border); font-size: .82rem; }.players b { display: flex; align-items: center; gap: .4rem; min-width: 0; }.players > span { color: var(--text-muted); font-size: .7rem; }.players i { width: 11px; height: 11px; flex: 0 0 auto; border: 1px solid var(--text-muted); border-radius: 50%; }.white-piece { background: #fff; }.black-piece { background: #272822; }
.variation { display: grid; gap: .3rem; min-height: 68px; padding: .7rem 1rem; background: var(--surface-strong); border-bottom: 1px solid var(--border); }.variation > span { color: var(--text-muted); font-size: .66rem; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; }.variation code { overflow: hidden; color: var(--text); font-size: .78rem; text-overflow: ellipsis; white-space: nowrap; }.variation small { color: var(--text-muted); }
.move-insight { display: grid; gap: .45rem; margin-top: auto; padding: .9rem 1rem; border-top: 1px solid var(--border); }.move-insight > div { display: flex; align-items: center; gap: .65rem; }.move-insight > div > strong { font: 700 1.05rem ui-monospace, monospace; }.classification { padding: .3rem .55rem; color: #fff; background: #71865d; border-radius: 6px; font-size: .7rem; font-weight: 800; }.classification.inaccuracy { background: #c18a2e; }.classification.mistake { background: #c5643f; }.classification.blunder { background: #a94332; }.move-insight p { margin: 0; font-size: .8rem; }.move-insight small { color: var(--text-muted); }.move-insight code { color: var(--accent); font-weight: 700; }
