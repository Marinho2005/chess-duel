  ...
  <main class="bots-page">
    ...
    <section v-if="bots.length && selectedBotDetails" class="setup-card">
      ...
      <div class="match-options">
        ...
        <fieldset><legend>Jogar com</legend><label v-for="item in [{id:'white',label:'♙ Brancas'},{id:'black',label:'♟ Pretas'},{id:'random',label:'⇄ Surpresa'}]" :key="item.id"><input v-model="color" type="radio" :value="item.id"><span>{{ item.label }}</span></label></fieldset>
      </div>
