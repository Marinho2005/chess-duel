...
.guest-card { display: grid; width: min(540px, 100%); justify-items: center; gap: 1rem; padding: 2.2rem; text-align: center; background: #fffaf0e8; border: 1px solid #e8dac4; border-radius: 18px; box-shadow: 0 20px 45px #60401f1c; }
...
.piece { color: #925b35; font-size: 4rem; line-height: 1; }.guest-card h1 { margin: 0; font: 500 1.8rem Georgia, serif; }.guest-card p { margin: 0; color: #806d5d; }.guest-card > small, .room-waiting small { color: #8b7664; }
...
.choices { display: grid; width: 100%; grid-template-columns: 1fr 1fr; gap: .7rem; }.choices button, .room-link-row button, .leave { padding: .75rem 1rem; border: 1px solid #d9c7ae; border-radius: 9px; cursor: pointer; }.choices button:disabled { opacity: .6; cursor: default; }.primary { color: white; background: #925b35; }.secondary { color: #765039; background: #f7eedf; }.danger { color: white; background: #a74c35; }
