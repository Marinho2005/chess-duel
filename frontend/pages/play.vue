...
.search-status { display: flex; align-items: center; gap: .6rem; margin: 0; padding: .75rem; color: var(--text-muted); background: var(--surface-strong); border-radius: 9px; font-size: .78rem; }.search-status i { width: 8px; height: 8px; flex: 0 0 auto; background: var(--success); border-radius: 50%; box-shadow: none; animation: pulse 1.1s infinite; }@keyframes pulse { 50% { opacity: .35; transform: scale(.75); } }.error { margin: 0; padding: .75rem; color: var(--danger); background: var(--danger-soft); border-radius: 9px; font-size: .8rem; }
