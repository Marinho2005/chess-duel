...
.puzzle-panel { display:grid; gap:1rem; padding:1.15rem; background:#fffaf0ec; border:1px solid #dfcfb8; border-radius:16px; box-shadow:0 18px 38px #6f452817; }.rating-row { display:flex; align-items:center; justify-content:space-between; padding-bottom:.9rem; color:#806d5d; border-bottom:1px solid #e3d3bd; font-size:.78rem; font-weight:750; }.rating-row strong { color:#6f4528; font:700 1.55rem var(--font-serif); }
