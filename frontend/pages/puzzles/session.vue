...
.puzzle-panel { display:grid; gap:1rem; padding:1.15rem; background:#fffaf0ec; border:1px solid #dfcfb8; border-radius:16px; box-shadow: 0 18px 38px rgb(0 0 0 / 14%); }.rating-row { display:flex; align-items:center; justify-content:space-between; padding-bottom:.9rem; color:#806d5d; border-bottom:1px solid #e3d3bd; font-size:.78rem; font-weight:750; }.rating-row strong { color:#6f4528; font:700 1.55rem var(--font-serif); }
.feedback { display:flex; align-items:flex-start; gap:.8rem; min-height:98px; padding:1rem; background:#f4eadb; border:1px solid #dfcfb8; border-radius:12px; }.feedback-icon { display:grid; width:38px; height:38px; flex:0 0 auto; place-items:center; color:#fff8e8; background:#775336; border-radius:50%; }.feedback>div { display:grid; gap:.28rem; }.feedback small { color:#8c715d; font-size:.66rem; font-weight:850; letter-spacing:.08em; text-transform:uppercase; }.feedback strong { font:600 1rem/1.4 var(--font-serif); }.feedback.correct,.feedback.solved { background:#e8f0df; border-color:#b8cba5; }.feedback.correct .feedback-icon,.feedback.solved .feedback-icon { background:#587344; }.feedback.incorrect,.feedback.failed { background:#f5e1db; border-color:#deb8ad; }.feedback.incorrect .feedback-icon,.feedback.failed .feedback-icon { background:#a44738; }.feedback.expired { background:#eee4d8; }.feedback.expired .feedback-icon { background:#694b37; }
