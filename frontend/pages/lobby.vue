...
<template>
  <main class="lobby-shell">
    <aside class="sidebar">
      <div class="logo">♟ <span>ChessDuel</span></div>
      <nav>
...
.sidebar { position: sticky; top: 0; display: flex; height: 100vh; flex-direction: column; gap: 2rem; padding: 2rem 1.4rem; background: #fffaf0dd; border-right: 1px solid var(--line); }
.logo { color: var(--brown); font-size: 1.5rem; }.logo span { font: 700 1.7rem Georgia, serif; }
nav { display: grid; gap: 0.5rem; } nav a { padding: 0.85rem 1rem; color: #806d5d; text-decoration: none; border-radius: 10px; } nav a.active { color: var(--ink); background: #efe2ce; border: 1px solid var(--line); }
