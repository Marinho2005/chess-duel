...
.welcome, .panel { padding: 1.6rem; background: #fffaf0e8; border: 1px solid #eadcc7; border-radius: 18px; box-shadow: 0 14px 30px rgb(0 0 0 / 14%); }
...
.connection { margin: 0; color: #6f855c; font-size: 0.9rem; }.online-dot { display: inline-block; width: 7px; height: 7px; background: #668a57; border-radius: 50%; box-shadow: none; }
...
.mode-card { display: grid; min-height: 164px; grid-template-columns: auto 1fr; align-items: center; gap: 1.2rem; padding: 1.35rem; color: var(--text); background: var(--surface); border: 1px solid var(--border-subtle); border-radius: 12px; text-decoration: none; box-shadow: none; transition: transform 180ms ease, background 180ms ease, border-color 180ms ease; }
...
.panel { padding: 1.5rem; background: var(--surface); border-color: var(--border-subtle); border-radius: 12px; box-shadow: none; scroll-margin-top: 96px; }
...
.eyebrow { color: var(--accent); background: color-mix(in srgb, var(--accent) 13%, transparent); }.connection { color: var(--success); }.online-dot { background: var(--success); box-shadow: none; }
...
.player-row, .online-card { background: var(--surface-strong); border-color: var(--border); }.player-link { color: var(--text); }.player-link:hover { color: var(--accent); }.empty { border-color: var(--border); }.error { color: var(--danger); background: var(--danger-soft); }.search-status { border-color: var(--border); }.search-status span { background: var(--success); box-shadow: none; }
...
.dashboard-grid { display: grid; grid-template-columns: 1.12fr .9fr .98fr; gap: 1rem; }.dashboard-grid .panel { min-width: 0; }.widget-heading { display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.1rem; }.widget-heading h2 { font-size: 1.05rem; }.widget-heading a { padding: .38rem .58rem; color: var(--accent); border: 1px solid var(--border); border-radius: 7px; font-size: .8125rem; text-decoration: none; }.widget-heading svg { color: var(--accent); }.widget-state { min-height: 128px; display: grid; place-items: center; margin: 0; color: var(--text-muted); text-align: center; }.recent-list { display: grid; }.recent-row { display: grid; grid-template-columns: 72px minmax(0, 1fr) auto; align-items: center; gap: .75rem; padding: .7rem 0; color: var(--text); border-bottom: 1px solid var(--border-subtle); text-decoration: none; }.recent-row:last-child { border-bottom: 0; }.recent-row:hover strong:first-child { color: var(--accent); }.recent-row > span:not(.result-pill) { display: grid; min-width: 0; overflow-wrap: anywhere; gap: .18rem; }.recent-row small { color: var(--text-muted); font-size: .8125rem; }.result-pill { padding: .42rem .5rem; border-radius: 6px; font-size: .8125rem; font-weight: 700; text-align: center; }.result-pill.win { color: var(--text); background: var(--success-soft); }.result-pill.loss { color: var(--text); background: var(--danger-soft); }.result-pill.draw { color: var(--text); background: var(--surface-strong); }.recent-meta { justify-items: end; }.positive { color: var(--success) !important; }.negative { color: var(--danger) !important; }.metric-label, .sample-note { color: var(--text-muted); }.rating-value { display: flex; align-items: baseline; gap: .65rem; margin: .35rem 0; }.rating-value > strong { font-size: 2.5rem; letter-spacing: -.05em; }.rating-value > span { color: var(--text-muted); font-weight: 700; }.sample-note { display: block; font-size: .875rem; line-height: 1.5; text-wrap: pretty; }.performance-stats { display: grid; grid-template-columns: repeat(3, 1fr); margin: 1.35rem 0 0; padding-top: 1rem; border-top: 1px solid var(--border-subtle); }.performance-stats div { display: grid; justify-items: center; gap: .28rem; border-right: 1px solid var(--border-subtle); }.performance-stats div:last-child { border: 0; }.performance-stats dt { color: var(--text-muted); font-size: .8125rem; text-align: center; }.performance-stats dd { margin: 0; font-size: 1.15rem; font-weight: 700; }.training-panel > a { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: .75rem; padding: .72rem; color: var(--text); border-bottom: 1px solid var(--border-subtle); text-decoration: none; }.training-panel > a:last-child { border: 0; }.training-panel > a:hover { background: var(--surface-hover); border-radius: 8px; }.training-panel > a > svg { color: var(--accent); }.training-panel > a span { display: grid; gap: .15rem; }.training-panel > a small { color: var(--text-muted); }
.performance-tabs { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: .35rem; margin: -.25rem 0 1rem; }.performance-tabs button { display: flex; min-width: 0; min-height: 34px; align-items: center; justify-content: center; gap: .35rem; padding: .42rem .35rem; color: var(--text-muted); background: var(--surface-strong); border: 1px solid var(--border-subtle); border-radius: 7px; font-size: .8125rem; font-weight: 700; }.performance-tabs button:hover { color: var(--text); border-color: var(--accent); transform: none; }.performance-tabs button.active { color: var(--accent-ink); background: var(--accent); border-color: var(--accent); }.performance-panel[aria-busy="true"] .rating-value,.performance-panel[aria-busy="true"] .sample-note,.performance-panel[aria-busy="true"] .performance-chart,.performance-panel[aria-busy="true"] .performance-stats { opacity: .55; }
.performance-chart { margin-top: .8rem; padding: .35rem .45rem .3rem; background: color-mix(in srgb, var(--surface-strong) 72%, transparent); border: 1px solid var(--border-subtle); border-radius: 8px; }.performance-chart svg { display: block; width: 100%; height: 72px; overflow: visible; }.performance-chart line { stroke: var(--border-subtle); stroke-width: 1; stroke-dasharray: 3 5; }.performance-chart polygon { fill: color-mix(in srgb, var(--accent) 13%, transparent); }.performance-chart polyline { fill: none; stroke: var(--accent); stroke-width: 3; stroke-linecap: round; stroke-linejoin: round; vector-effect: non-scaling-stroke; }.performance-chart circle { fill: var(--surface); stroke: var(--accent); stroke-width: 2.5; vector-effect: non-scaling-stroke; }.performance-chart > div { display: flex; justify-content: space-between; gap: .5rem; color: var(--text-muted); font-size: .8125rem; font-variant-numeric: tabular-nums; flex-wrap: wrap; }.performance-chart + .performance-stats { margin-top: .8rem; }
...
.friends-empty { display: grid; min-height: 128px; place-items: center; align-content: center; gap: .35rem; padding: 1rem; color: var(--text); text-align: center; text-decoration: none; border: 1px dashed var(--border); border-radius: 10px; }.friends-empty span { color: var(--text-muted); font-size: .875rem; line-height: 1.5; }.friends-empty:hover strong { color: var(--accent); }
