...
<style scoped>
.callback-page { display: grid; min-height: 100vh; place-items: center; padding: 1rem; color: var(--text); background: radial-gradient(circle at 50% 18%, color-mix(in srgb,var(--accent) 10%,transparent), transparent 32%), var(--bg); }
...
h1 { display: flex; justify-content: center; margin: 0.5rem 0; font-size: 2rem; }
p { margin: 0; color: var(--text-muted); font-family: var(--font-sans); }
</style>
