...
.page-header { display: flex; width: min(920px, 100%); margin: 0 auto 2rem; align-items: flex-end; justify-content: space-between; }.back { display: block; margin-bottom: 2rem; color: #7f5130; text-decoration: none; }.back:hover { text-decoration: underline; }.eyebrow { color: #6f4528; font-size: .72rem; font-weight: 800; letter-spacing: .12em; }.page-header h1 { margin: .35rem 0; font: 500 clamp(2.2rem, 6vw, 3.7rem) Georgia, serif; }.page-header p { margin: 0; color: #806d5d; }.piece { color: #6f4528; font-size: 4.5rem; }
.game-list, .status-card { width: min(920px, 100%); margin: 0 auto; }.game-list { display: grid; gap: .85rem; }.game-card { display: grid; grid-template-columns: 110px 1fr auto; align-items: center; gap: 1.2rem; padding: 1.15rem; background: #fffaf0e8; border: 1px solid #eadcc7; border-radius: 16px; box-shadow: 0 8px 24px #6f452812; }.result-mark { padding: .65rem .8rem; text-align: center; font-weight: 800; border-radius: 10px; }.result-mark.win { color: #42663d; background: #dfeeda; }.result-mark.loss { color: #93402f; background: #f3ddd7; }.result-mark.draw { color: #715d49; background: #e9dfd0; }
.opponent { display: flex; min-width: 0; align-items: center; gap: .9rem; }.avatar { display: grid; width: 46px; height: 46px; flex: 0 0 auto; place-items: center; color: white; background: #6f4528; border-radius: 50%; font: 700 1.1rem Georgia, serif; }.opponent div { display: grid; min-width: 0; gap: .15rem; }.opponent small, .opponent span, .details small, .details time { color: #857060; font-size: .78rem; }.opponent a { overflow: hidden; color: #3c2b20; font-weight: 800; text-overflow: ellipsis; text-decoration: none; white-space: nowrap; }.opponent a:hover { color: #6f4528; text-decoration: underline; }
.details { display: grid; min-width: 145px; justify-items: end; gap: .15rem; }.details strong { color: #715d49; }.details strong.positive { color: #4e7748; }.details strong.negative { color: #ae4b37; }.details time { margin-top: .25rem; }.status-card { padding: 3rem 1.5rem; text-align: center; background: #fffaf0e8; border: 1px solid #eadcc7; border-radius: 18px; }.empty span { color: #6f4528; font-size: 3rem; }.empty h2 { font-family: Georgia, serif; }.empty p { color: #806d5d; }.empty a, .load-more { display: inline-block; padding: .85rem 1.2rem; color: white; font-weight: 700; text-decoration: none; background: #6f4528; border: 0; border-radius: 10px; }.error { color: #a53e2e; }.load-more { margin: 1rem auto 0; cursor: pointer; }.load-more:disabled { opacity: .65; cursor: wait; }
.details .review-link { margin-top: .45rem; padding: .42rem .65rem; color: #fffaf0; font-size: .75rem; font-weight: 700; text-decoration: none; background: #6f4528; border-radius: 7px; }
