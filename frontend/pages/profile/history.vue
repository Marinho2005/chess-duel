...
<style scoped>
.history-shell { min-height: 100vh; padding: clamp(1.2rem, 5vw, 4rem); color: var(--text); background-color: var(--bg); background-image: radial-gradient(var(--pattern-dot) 0.7px, transparent 0.7px); background-size: 5px 5px; font-family: Inter, system-ui, sans-serif; }
