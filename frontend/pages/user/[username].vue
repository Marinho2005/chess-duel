...
type PublicProfile = { id:string; nickname:string; country:string|null; country_code:string|null; avatar_url:string|null; status:'online'|'offline'|'away'|'dnd'; inserted_at:string; ratings:PlayerRatings; stats:{total_games:number;win_rate:number;current_streak:number}; recent_games:RecentGame[] }
...
<template>
  <main class="profile-page"><div class="content">
    ...
    <template v-else-if="profile">
      <section class="hero">
        <ProfilePresenceAvatar :name="profile.nickname" :avatar-url="profile.avatar_url" :status="profile.status" :size="88" />
