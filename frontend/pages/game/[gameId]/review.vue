...
<style scoped>
.review-shell { min-height: 100vh; padding: .65rem clamp(1rem, 3vw, 2.5rem) 1.5rem; color: var(--text); background-color: var(--bg); background-image: radial-gradient(var(--pattern-dot) .7px, transparent .7px); background-size: 5px 5px; font-family: var(--font-sans); }
.page-header { display: flex; width: min(990px, 100%); min-height: 76px; margin: 0 auto .7rem; align-items: center; justify-content: space-between; gap: 1rem; }.page-header a { display: block; margin-bottom: .3rem; color: var(--accent); font-size: .82rem; text-decoration: none; }.page-header a:hover { text-decoration: underline; }.page-header div > span { color: var(--accent); font-size: .62rem; font-weight: 800; letter-spacing: .13em; }.page-header h1 { margin: .12rem 0 0; color: var(--text); font: 500 clamp(1.75rem, 3.2vw, 2.35rem) var(--font-serif); }.sound-toggle { display: inline-flex; align-items: center; gap: .3rem; padding: .38rem .55rem; color: var(--text); background: var(--surface); border: 1px solid var(--border); border-radius: 8px; font: 700 .7rem var(--font-sans); cursor: pointer; }.sound-toggle:hover { background: var(--surface-hover); }
...
.state { width: min(700px, 100%); margin: 4rem auto; padding: 3rem; color: var(--text); text-align: center; background: color-mix(in srgb, var(--surface) 96%, transparent); border: 1px solid var(--border); border-radius: 16px; box-shadow: var(--shadow); }.state h2 { color: var(--text); font-family: var(--font-serif); }.state p, .state small { color: var(--text-muted); }.state i { display: block; width: 30px; height: 30px; margin: auto; border: 3px solid var(--border); border-top-color: var(--accent); border-radius: 50%; animation: spin 1s linear infinite; }.state button { padding: .7rem 1rem; color: var(--accent-ink); background: var(--accent); border: 0; border-radius: 8px; cursor: pointer; }.state button:hover { background: var(--accent-hover); }.error { color: var(--danger); }
